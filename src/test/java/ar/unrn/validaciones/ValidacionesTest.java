...
// @BeforeEach
// public void setUp() {
// validacionEmail = new Validaciones("^[\\w-\\.]+@([\\w-]+\\.)+[\\w-]{2,4}$",
// "Email inválido", new JTextField());
// validacionTelefono = new Validaciones("^\\d{10}$", "Número de teléfono
// inválido", new JTextField());
// validacionNombre = new Validaciones("^[A-Za-z ]+$", "Nombre inválido", new
// JTextField());
// }
