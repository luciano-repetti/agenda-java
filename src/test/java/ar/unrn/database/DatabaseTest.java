...
// Contacto contactoActualizado = new Contacto(contacto.id.toString(), "John",
...
// List<Contacto> contactos = database.getContactos(true);
// Assertions.assertEquals(1, contactos.size());
// Assertions.assertEquals(contactoActualizado.numeroTelefono,
// contactos.get(0).numeroTelefono);
...
// Assertions.assertEquals(contactoActualizado.direccion.calle,
// contactos.get(0).direccion.calle);
// }
